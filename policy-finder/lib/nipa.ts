...
// 결과·행정성 공고(있으면 제외) — 접수 신호가 있어도 결과류·행정성이면 뺀다
const SKIP_RE =
  /선정\s?결과|선정결과|결과\s?공고|결과\s?발표|최종\s?선정|선정기업|선정\s?계획|평가\s?결과|합격|명단|당첨|개정|폐지|규정|훈령|고시|공고문\s?정정|정정\s?공고|낙찰|계약\s?체결|사업\s?종료|폐강|지정\s?신청|기관\s?지정|지정\s?공고|지정제도|시험평가기관|평가기관|인증기관|위탁기관|수행기관\s?지정|채용|입찰|의견\s?수렴|공청회|설명회|간담회|연구기획|연구개발과제|연구과제|신규과제|계속과제|국책과제|연구자|박사후|포스닥|논문|학술|활동지원사업|기술료|연구비|표준개발|표준화/;
