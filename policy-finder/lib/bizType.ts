...
// 예비창업·초기창업·스타트업 등 (소상공인 신호가 없을 때 도달)
const CHANGUP =
  /예비창업|초기창업|창업초기|창업\s?3년|창업\s?7년|스타트업|창업기업|창업도약|창업패키지|1인\s?창업|재창업|딥테크|팁스|TIPS|사내벤처|글로벌\s?창업|창업사관학교|창업중심대학|창업\s?아이템|창업교육|창업\s?과정|창업스쿨|창업캠프|창업\s?아카데미|액셀러러|인큐베이[팅션]/;

// 중소·중견·벤처·기술기업 등 (소상공인·창업 신호가 없을 때 도달)
// 소상공인엔 거의 없는 기술·R&D·조달 신호를 포함해 '공통' 오분류를 줄인다.
const SME =
  /중소기업|중견기업|벤처기업|이노비즈|메인비즈|글로벌\s?강소|강소기업|스케일업|중소·중견|중소중견|기업부설연구소|연구개발|기술개발|R&D|알앤디|성능평가|시제품|기술이전|공공조달|조달\s?입찰|수출바우처|무역사절단|해외\s?진출|기술사업화|산학협력|지식재산|IP\s?바우처/;
